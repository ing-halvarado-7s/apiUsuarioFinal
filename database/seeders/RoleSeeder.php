...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'asignarol'])->syncRoles([$role1]);
        Permission::create(['name' => 'quitarrol'])->syncRoles([$role1]);
        Permission::create(['name' => 'agregarpermisorol'])->syncRoles([$role1]);
        Permission::create(['name' => 'quitarpermisorol'])->syncRoles([$role1]);
    }
}
